...
/**
 * io.codeforall.bootcamp.UDPClient class that sends packets to a specific UDP host server and receives it's response
 */
class UDPClient {
    ...
    /**
     * io.codeforall.bootcamp.UDPClient entry point
     *
     * @param args
     * @throws IOException
     */
